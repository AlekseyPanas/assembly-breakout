...
custom_levels: .word 1:2655  # struct level[5]
    ...
    IF_run_menu_3:
        ...
        ELIF_run_menu_2: # elif (keyboard.key == ' ')
            ...
            IF_run_menu_5: # if (menu_state.state == 0)
                ...
                li $t8, 0
                sb $t8, 2148($t2)
                li $t9, 3              # TODO: Change level index back to 0
                sb $t9, 2149($t2)
                sw $t8, 2152($t2)
                li $t1, 3
                sw $t1, 2156($t2)
...
fn_run_level_sel_menu: # () -> void
    ...
    IF_run_level_sel_menu_2:
        ...
        beq $t4, 1, SKIPMARKER_run_level_sel_menu_3
        ...
        ELIF_run_level_sel_menu_1: # elif (keyboard.key == 'd' && menu_state.level_idx < 4 && regular_levels[menu_state.level_idx + 1] != NULL)
            # menu_state.level_idx++
            la $t0, menu_state
            lbu $t1, 1($t0)
            addi $t1, $t1, 1
...
fn_run_editor_menu: # () -> void
    ...
    IF_run_editor_menu_1:
        ...
        # TODO: Jump into drawing functions
...
fn_run_game: # () -> void
    ...
    IF_run_game_5:
        ...
        ELIF_run_game_5: # elif (keyboard.is_pressed && keyboard.key == ' ')
            ...
            IF_run_game_35:
                # game.ball_vel.x = random(-6, 6), game.ball_vel.y = random(-8, -2)
                li $v0, 42
                li $a0, 0
                li $a1, 12
                syscall
...
fn_move_paddle: # (int x_shift) -> void
    ...
    # for i in [x_shift, x_shift - 1, ..., 1]
    LOOP_move_paddle_1:
        lw $t1, 8($sp)
        beq $t1, 0, ENDLOOP_move_paddle_1
...
# TODO: Add rate divider to slow level speed
