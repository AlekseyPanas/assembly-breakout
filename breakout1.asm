        ...
        LOOP_run_game_2: # while (i < loop_amount)
            ...
            LOOP_run_game_3: # while (b < num_bricks)
                ...
                IF_run_game_11:
                    ...
                    sw $t1, 0($sp)
                    subi $sp, $sp, 4
                    lw $t1, 20($sp)  # future_x.x
                    sw $t1, 0($sp)
                    subi $sp, $sp, 4
                    lw $t1, 72($sp)  # future_x.y
                    sw $t1, 0($sp)
                    subi $sp, $sp, 4
                    li $t1, 3  # // ball width
                    sw $t1, 0($sp)
                    ...
                    sw $t1, 0($sp)
                    subi $sp, $sp, 4
                    lw $t1, 28($sp)  # future_y.x
                    sw $t1, 0($sp)
                    subi $sp, $sp, 4
                    lw $t1, 80($sp)  # future_y.y
                    sw $t1, 0($sp)
                    subi $sp, $sp, 4
                    li $t1, 3  # // ball width
                    sw $t1, 0($sp)
                    ...
                    sw $t1, 0($sp)
                    subi $sp, $sp, 4
                    lw $t1, 24($sp)  # future_neg_x.x
                    sw $t1, 0($sp)
                    subi $sp, $sp, 4
                    lw $t1, 76($sp)  # future_neg_x.y
                    sw $t1, 0($sp)
                    subi $sp, $sp, 4
                    li $t1, 3  # // ball width
                    sw $t1, 0($sp)
                    ...
                    sw $t1, 0($sp)
                    subi $sp, $sp, 4
                    lw $t1, 32($sp)  # future_neg_y.x
                    sw $t1, 0($sp)
                    subi $sp, $sp, 4
                    lw $t1, 84($sp)  # future_neg_y.y
                    sw $t1, 0($sp)
                    subi $sp, $sp, 4
                    li $t1, 3  # // ball width
                    sw $t1, 0($sp)
